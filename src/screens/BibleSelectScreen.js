                ...
                <View>
                    ...
                    <FlatList
                        ...
                        renderItem={({ item }) => (
                            // console.log(item)
                            <View>
                                <TouchableOpacity style={{ height: 30, width: 150, backgroundColor: 'black' }} onPress={() => { navigation.navigate({ name: 'BibleScreen', params: { chapter: `${item.id}`, version: `${bible}` } }) }}>
                                    <Text style={{ color: 'white', fontSize: 12 }}>{item.number}</Text>
                                </TouchableOpacity>
                            </View>
                        )}
                    />
